...
class Session:
    ...
    def __init__(self, env, name="session"):
        ...
        self.explain_engine = ExplainEngine(env, self.ds)
    ...
    def setup_domain(self, columns):
        status, domain_time = self.domain_engine.setup(columns)
        logging.info(status)
    ...
    def explain_repairs(self, detectors):
        ...
        explanation, explain_time = self.explain_engine.explain_repairs(detectors)
