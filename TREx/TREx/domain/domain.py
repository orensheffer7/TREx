...
class DomainEngine:
    ...
    def setup_attributes(self, columns):
        self.active_attributes = columns
    ...
    def generate_domain(self):
        ...
        for row in list(records):
            tid = row['_tid_']
            if '_tid_' in self.active_attributes:
                self.active_attributes.remove('_tid_')
        ...
        num_weak_labels = 0
        updated_domain_df = []
        for preds, row in zip(preds_by_cell, domain_df.to_records()):
